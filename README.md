...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/BCbM7IGY5N)
...
```sh
npx nx serve livia-premium
```

To create a production bundle:

```sh
npx nx build livia-premium
```

To see all available targets to run for a project, run:

```sh
npx nx show project livia-premium
```
